...
<body>
  ...
  <a class="anchorStyle" href="#">
      ...
      <div class="thirdOffer">
        ...
        <div class="beneffits">
          <ul>
            ...
            <li class="liMargin">- Подобряване на сегашната техника</li>
    ...
    <div class="whoForDiv">
      <h1 class="headerWhoFor"><b>Не сте сигурни дали &nbsp &nbsp &nbsp &nbsp да пробвате?</b></h1>
    ...
    <div class="textSwimming">
      <p>Ние от спортен клуб СКП вярваме, че плуването е един от най-хубавите спортове, който може да изберете за вас и вашето дете. <br><br>
        ...
        <br><br>Тове е един от най-добрите начини да поддържаме здравето си в оптимално състояние.
        <br>Научете повече за ползите от плуването в секция: <button class="learnMore"><a href="#imgP">Защо плуване?</a></button>
